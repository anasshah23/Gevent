    ...
    4508: (e, t, s) => {
      ...
      class IconsManager {
        ...
        createSymbolElement(e) {
          let { id: t, path: s, width: n, height: i } = e;
          return this.createSvgNode("symbol", {
            props: { innerHTML: '<path d="' + s + '"></path>', id: t },
            attrs: { viewBox: "0 0 " + n + " " + i },
          });
        }
      }
      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        setVideoContent(e) {
          ...
          const n = this.getSettings("classes"),
            i = t("<div>", { class: `${n.videoContainer} ${n.preventClose}` }),
            o = t("<div>", { class: n.videoWrapper });
          o.append(s), i.append(o);
          const l = this.getModal();
          l.setMessage(i), this.setVideoAspectRatio();
          const r = l.onHide;
          l.onHide = function () {
            r(),
              (this.$buttons = jQuery()),
        ...
        getShareLinks() {
          const { i18n: e } = elementorFrontend.config,
            ...
            l = s("<div>", { class: n.slideshow.shareLinks }),
              ...
              const n = t.label,
                i = s("<a>", {
                  href: this.createShareLink(
                    e,
                    c,
                    r.attr("data-e-action-hash")
                  ),
                  target: "_blank",
                }).text(n),
                o = this.isFontIconSvgExperiment
                  ? s(t.iconElement.element)
                  : s("<i>", { class: "eicon-" + e, "aria-hidden": "true" });
              i.prepend(o), l.append(i);
            }),
            !d)
          ) {
          ...
          if (s || n || o || l) {
            if (
              ...
              n.on("click", (e) => {
                ...
                (d.$shareMenu = t("<div>", { class: a.shareMenu }).append(n)),
                d.$iconShare
                  .add(d.$shareMenu)
            ...
            if (o) {
              const s = this.isFontIconSvgExperiment
                ...
                l = { ...o };
              this.isFontIconSvgExperiment || (l.class = a.iconZoomIn),
            ...
            if (n) {
              const s = this.isFontIconSvgExperiment
                ...
                l = { ...o };
              this.isFontIconSvgExperiment || (l.class = a.iconExpand),
                (d.$iconExpand = t(s)
        ...
        setSlideshowContent(e) {
          ...
          if (
            (e.slides.forEach((e) => {
              ...
              if (e.video) {
                ...
                const n = this.isFontIconSvgExperiment
                    ? i.loading.element
                    : "<i>",
                  l = s("<div>", { class: a.playButton }).html(
                    s(n)
            ...
            const e = this.isFontIconSvgExperiment
                ...
                : s("<i>", { class: d.prevButtonIcon, "aria-hidden": "true" }),
              n = this.isFontIconSvgExperiment
                ? s(i.chevronRight.element)
                : s("<i>", { class: d.nextButtonIcon, "aria-hidden": "true" }),
              o = s("<span>", { class: "screen-reader-text" }).html(t.previous),
              l = s("<span>", { class: "screen-reader-text" }).html(t.next);
            (m = s("<div>", {
          ...
          u.onShow = async () => {
            ...
            n || (t.navigation = { prevEl: m[0], nextEl: p[0] }),
        ...
        playSlideVideo() {
          ...
          n.append(i),
            ...
            -1 !== t.indexOf("vimeo.com")
              ? ((l = "vimeo"), (r = elementorFrontend.utils.vimeo))
              : t.match(
                  /^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/
                ) && ((l = "youtube"), (r = elementorFrontend.utils.youtube));
          const a = r.getVideoIDFromURL(t);
          r.onApiReady((e) => {
            "youtube" === l
              ? this.prepareYTVideo(e, a, n, i, o)
              : "vimeo" === l && this.prepareVimeoVideo(e, t, n, i, o);
          }),
            o.addClass(s.playing).removeClass(s.hidden);
        },
        prepareYTVideo(e, t, s, n, i) {
