        ...
        e.ajax({
          ...
          beforeSend: function () {
            t.addClass("ekit-ajax-loading"),
              n.toggleClass(
                "icon icon-down-arrow1 eicon-loading eicon-animation-spin"
              ),
          ...
          success: function (s) {
            t.removeClass("ekit-ajax-loading"),
              ...
              n
                .toggleClass(
                  "eicon-loading eicon-animation-spin icon icon-down-arrow1"
                )
                .removeAttr("style"),
  ...
  let n = {
    ...
    Image_Accordion: function (t) {
      ...
      t.on("click", ".ekit-image-accordion-item", function (t) {
        ...
        if ("hover" === o || i === this) !l && s?.url && window.open(s.url, r);
        else {
